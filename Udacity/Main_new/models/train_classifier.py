...
def evaluate_model(model, X_test, Y_test, category_names):
    ...
    #Predicting the test variable of each column
        ...
        print('precison is for',columns[col],'is',precision_score(tested, predicted,average='micro'))
        print('Recall is for',columns[col],'is',recall_score(tested, predicted,average='micro'))
